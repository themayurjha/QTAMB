      ...
      <section className="py-12 md:py-20">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto bg-white p-6 md:p-8 rounded-xl shadow-sm border">
            ...
            <p className="text-gray-600">- Sarah, using Questions to Ask Your Boyfriend for 3 months</p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 py-6 md:py-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <div className="flex items-center space-x-2">
              ...
              <span className="font-medium">Questions to Ask Your Boyfriend</span>
            </div>
            <div className="text-sm text-gray-600">
              © 2024 Questions to Ask Your Boyfriend. All rights reserved.
            </div>
          </div>
        </div>
      </footer>
